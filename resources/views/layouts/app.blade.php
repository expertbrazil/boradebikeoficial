...
<body class="bg-gray-50">
    @php
        // Garante que $siteLogo exista mesmo quando a view não passar explicitamente
    ...
    <footer class="bg-gray-900 text-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                <!-- Marca do evento + frase -->
                <div>
                    <div class="flex items-start md:items-center gap-4 mb-4">
                        @if($siteLogo)
                            <img src="{{ asset('storage/' . $siteLogo) }}" alt="Bora de Bike" class="h-20 w-auto">
                        @else
                            <h3 class="text-2xl font-bold">Bora de Bike</h3>
                        @endif
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-gray-300 flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-center md:text-left">&copy; {{ date('Y') }} Bora de Bike. Todos os direitos reservados.</p>
                <a href="https://expertbrazil.com" target="_blank" rel="noopener" class="flex flex-col items-center md:items-end gap-2 group">
                    <img src="{{ asset('storage/logos/expertbrazil.svg') }}" alt="Expert Brazil" class="h-10 w-auto opacity-90 group-hover:opacity-100 transition-opacity">
                    <span class="text-sm text-gray-400 group-hover:text-gray-200 transition-colors">Obtenha a solução certa para o seu negócio</span>
                </a>
            </div>
        </div>
    </footer>
