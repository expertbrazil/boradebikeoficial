...
@section('title', 'Adicionar Item da Programação - Admin')
@section('page-title', 'Adicionar Item da Programação')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b">
            <h3 class="text-lg font-medium text-gray-900">Adicionar Novo Item da Programação</h3>
        </div>
        
        <form method="POST" action="{{ route('admin.schedule.store') }}" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Descrição detalhada da atividade">{{ old('description') }}</textarea>
