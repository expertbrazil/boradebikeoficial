...
<section id="route" class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Trajeto do Evento</h2>
            <div class="w-24 h-1 bg-blue-600 mx-auto mb-6"></div>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto">
                Visualize o trajeto completo do evento diretamente no mapa
            </p>
        </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-blue-50 rounded-lg p-6 text-center">
                    <i class="fas fa-route text-3xl text-blue-600 mb-3"></i>
                    <h4 class="font-semibold text-gray-900 mb-2">Trajeto Completo</h4>
                    <p class="text-sm text-gray-600">Explore todo o percurso do evento</p>
                </div>
                <div class="bg-green-50 rounded-lg p-6 text-center">
                    <i class="fas fa-map-marked-alt text-3xl text-green-600 mb-3"></i>
                    <h4 class="font-semibold text-gray-900 mb-2">Pontos de Interesse</h4>
                    <p class="text-sm text-gray-600">Veja os principais pontos do trajeto</p>
                </div>
                <div class="bg-orange-50 rounded-lg p-6 text-center">
                    <i class="fas fa-mountain text-3xl text-orange-600 mb-3"></i>
                    <h4 class="font-semibold text-gray-900 mb-2">Terreno Detalhado</h4>
                    <p class="text-sm text-gray-600">Visualize elevações e detalhes do terreno</p>
                </div>
            </div>
        </div>
    </div>
